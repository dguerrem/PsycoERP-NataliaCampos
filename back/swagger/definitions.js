const definitions = {
  ...
  RedeemBonusRequest: {
    ...
    properties: {
      patient_id: {
        type: "integer",
        format: "int64",
        description: "ID del paciente que posee el bono activo (requerido)",
        example: 5,
      },
      session_id: {
        type: "integer",
    ...
    properties: {
      ...
      data: {
        ...
        properties: {
          ...
          remaining_sessions: {
            type: "integer",
            description: "Sesiones restantes después de la redención",
            example: 6,
          },
          used_sessions: {
            type: "integer",
            description: "Sesiones utilizadas incluyendo esta redención",
            example: 4,
          },
          status: {
            type: "string",
            enum: ["active", "consumed", "expired"],
            description: "Estado actual del bono",
            example: "active",
          },
          expiration_date: {
            type: "string",
            format: "date",
            description: "Fecha de expiración del bono",
            example: "2025-12-31",
          },
          created_at: {
            type: "string",
            format: "date",
            description: "Fecha de creación del bono",
            example: "2025-01-15",
          },
          updated_at: {
            type: "string",
  ...
  UpdateBonusRequest: {
    ...
    properties: {
      expiration_date: {
        type: "string",
        format: "date",
        description: "Nueva fecha de expiración del bono (requerido, formato YYYY-MM-DD)",
        example: "2026-06-30",
      },
    },
  },
  ...
  UpdateBonusResponse: {
    ...
    properties: {
      ...
      message: {
        type: "string",
        example: "Fecha de expiración actualizada exitosamente",
      },
      data: {
        type: "object",
        properties: {
          ...
          used_sessions: {
            type: "integer",
            description: "Sesiones utilizadas",
            example: 3,
          },
          status: {
            type: "string",
          ...
          expiration_date: {
            type: "string",
            format: "date",
            description: "Nueva fecha de expiración actualizada",
            example: "2026-06-30",
          },
          created_at: {
            type: "string",
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      payment_method: {
                        ...
                        description: "Método de pago de la sesión",
                        example: "card",
                      },
                    },
                  },
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      payment_method: {
                        type: "string",
                        enum: ["cash", "card", "transfer", "insurance", "bonus"],
                        description: "Método de pago de la llamada",
                        example: "card",
                      },
                    },
                  },
